...
'''Train:
step1:
run imagenet.py to generate image_lagel
step2:
run resnet.py 
using image_label to generate  image_embedding
setp3:
run.py -- train()
'''
...
def main():
    ...
    #data_size = [len(train_dt)] #tra5380in model on just the maximum data size
