...
parser.add_argument('--model', type=str, default='/home/turtlepc-04/github/language detect/affordance_language/models/trained-model.pt',
...
parser.add_argument('--image_dir', type=str, default='/home/turtlepc-04/github/language detect/affordance_language/arm_image/',
...
parser.add_argument('--mode', type=str, default='YCB', help='3 possible evaluation modes: YCB, robot, eval')
...
elif  opt.mode== 'ealse': # evaluation on held-out test set
    vo_dict = None
 ...
 if opt.mode == 'robot': #robot demo
    ...
    with torch.no_grad():
       ...
       # print(top1)
        ...
        top = 'affordance_language/arm_image/' + top1
        image = Image.open(top)
        plt.imshow(image)
