...
parser.add_argument('--inputVO', type=str, default='/home/turtlepc-04/github/affordance_language/data/annotated-vo.csv', help='input verb-object file')
#below file is generated by resnet.py
parser.add_argument('--inputOA', type=str, default='/home/turtlepc-04/github/affordance_language/data/object-embedding.csv', help='input object-embedding file')
parser.add_argument('--train', type=str, default='/home/turtlepc-04/github/affordance_language/data/corpus-train.csv', help='output file')
parser.add_argument('--test', type=str, default='/home/turtlepc-04/github/affordance_language/data/corpus-test.csv', help='output file')
    ...
    with open(opt.inputOA, 'r') as inputOAFile:
        with open(opt.train, 'w', newline='') as outputTrain:
            with open(opt.test, 'w', newline='') as outputTest:
                ...
                with open('/home/turtlepc-04/github/affordance_language/data/vo_dict.json', 'w+') as f:
